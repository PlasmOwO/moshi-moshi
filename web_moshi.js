...
startBtn.onclick = async () => {
  ...
  // Remplace par l'adresse publique de ton serveur FastAPI
    const socket = new WebSocket("ws://13.38.29.146:8500/transcribe");
